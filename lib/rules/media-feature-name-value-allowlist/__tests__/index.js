...
testRule({
	...
	accept: [
		...
		},
		{
			...
			description: 'Non-standard syntax in allowlist',
		},
		{
			code: '@media (color) {}',
			description: 'Boolean context, media feature in allowlist',
		},
		{
			code: '@media (update) {}',
			description: 'Boolean context, media feature NOT in allowlist',
		},
		{
		...
		{
			code: '@media screen and (min-width <= 768px) {}',
			description: 'Range context, media feature in allowlist',
		},
	],
	...
	reject: [
		...
		},
		{
			...
			description: 'Non-standard syntax NOT in allowlist',
